...
namespace Argus.Common.Messages
{
    ...
    /// </summary>
    public record ResumeReply(string ResumePoint)
    {
        /// <summary>
        /// Gets the name of the message type.
        /// </summary>
        public static string MessageType => nameof(ResumeReply);
        ...
        /// <summary>
        /// Attempts to parse a resume reply from the given NetMQ message.
        /// </summary>
        ...
        public static bool TryParse(NetMQMessage message, [NotNullWhen(true)] out ResumeReply? status)
        {
            status = null;
            ...
            status = new ResumeReply(resumePoint);
            return true;
        }
