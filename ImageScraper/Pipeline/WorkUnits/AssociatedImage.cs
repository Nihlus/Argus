...
namespace ImageScraper.Pipeline.WorkUnits
{
    ...
    public sealed class AssociatedImage : IDisposable
    {
        ...
        /// <summary>
        /// Gets an open stream of the image data.
        /// </summary>
        public Stream ImageStream { get; }

        /// <summary>
        /// Initializes a new instance of the <see cref="AssociatedImage"/> class.
        /// </summary>
        ...
        public AssociatedImage(string service, Uri source, Uri link, Stream imageStream)
        {
